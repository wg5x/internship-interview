...
补充：2026-06-22 上午又新增 5 份简历。当前判断是：李子昊、来淼鑫、雷剑并入新增强初筛池；薛景瑞进入低优先初筛；黄可心因 PDF 文本不可读，需人工打开确认。
...
| 2026-06-25 周四 | 原补位池初筛：刘心怡、戴霖、王泽超、黄仟秋、田宏越 | 新增补位初筛：李子昊、来淼鑫、雷剑、邢耀文、牛韦杰 | 形成 A+/A-/候补/NG 初版 |
| 2026-06-26 周五 | 二面/设计实操：周一至周四通过者 | 面试官复盘、最终排序、回填跟进表；如有余量再初筛郝海程、于嘉琪、徐志磊、薛景瑞，黄可心待人工确认 | 输出 offer/候补/淘汰建议 |
