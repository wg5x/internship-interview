...
补充：2026-06-23 又新增一批文件。当前判断是：李昊泽、方浩、廖月华、王悦、朱坤进入新增补位 / 强初筛；安晨阳、赵柄州、雷君帆、王基宽进入低优先初筛；`tai-jinxue (ai-agent).pdf`、`于彤-15595168711.pdf`、`ai简历.pdf`、`求职简历-Agent开发实习生.pdf` 仍需人工打开确认。
...
| 2026-06-25 周四 | 原补位池初筛：刘心怡、戴霖、王泽超、黄仟秋、田宏越 | 新增补位初筛：李昊泽、方浩、廖月华、王悦、朱坤 | 形成 A+/A-/候补/NG 初版 |
| 2026-06-26 周五 | 二面/设计实操：周一至周四通过者 | 面试官复盘、最终排序、回填跟进表；如有余量再初筛李子昊、来淼鑫、雷剑、安晨阳、赵柄州、王基宽，黄可心待人工确认 | 输出 offer/候补/淘汰建议 |
